...
```
#The comman changes the names of the first three columns to "year", "month", and "day" and changes the other columns to names 0-23. The last 24 columns represent the hours in the day. 
